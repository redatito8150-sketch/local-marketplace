...
with expected_tables(table_name) as (
  values
    ...
    ('collections'), ('inventory_movements'), ('master_orders'), ('option_types'), ('option_values'),
...
from (
  values
    ...
    ('brands','setup_status'), ('brands','shipping_policy'),
    ('brands','sku_prefix'), ('brands','source_application_id'),
    ('brands','is_sponsored'), ('brands','sponsored_placements'),
    ...
    ('orders','master_order_id'), ('orders','payment_method'), ('orders','payment_status'),
    ('orders','shipping_fee_egp'),
    ('master_orders','master_order_number'), ('master_orders','user_id'),
