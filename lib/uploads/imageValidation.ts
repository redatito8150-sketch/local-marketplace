...
// Extends the same magic-byte pattern above to also recognize PDF, for
// brand application document uploads (application/pdf, image/jpeg,
// image/png — see lib/join/constants.ts#ALLOWED_DOCUMENT_MIME_TYPES).
