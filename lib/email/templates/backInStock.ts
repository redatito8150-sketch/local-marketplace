...
export function backInStockEmail(product: {
  ...
  return {
    ...
    html: emailShell(`
      ...
      <a href="${url}" style="display: inline-block; background: #C85956; color: #ffffff; text-decoration: none; padding: 12px 22px; border-radius: 8px; font-size: 14px; font-weight: 600;">
        Shop it now
      </a>
    `),
  };
