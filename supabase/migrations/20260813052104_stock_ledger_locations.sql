...
-- related_entity_type/related_entity_id all null forever â€” never backfilled.
-- ============================================================================
...
-- Additive widening only â€” every existing value stays valid, historical
-- rows are untouched.
...
-- ============================================================================
-- apply_warehouse_stock_correction â€” the ONE legitimate way to adjust
...
-- permission) â€” never callable by a brand-portal actor.
-- ============================================================================
