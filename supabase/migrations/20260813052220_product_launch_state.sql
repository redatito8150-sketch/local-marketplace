...
-- ============================================================================
-- Product launch state â€” the minimum safe backend addition to distinguish
...
-- variants â€” never cleared afterward, so a later stockout never hides the
...
-- products, so this only needs to run for those brands â€” a
...
-- movement row) â€” never a fabricated/guessed date, and never re-run
...
-- Same signature as the current version (20260809000001) â€” purely additive
-- body change.
...
-- the product â€” the moment a zakhnook_fulfilled product becomes launched.
