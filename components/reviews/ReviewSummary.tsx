...
export default function ReviewSummary({
    ...
    return (
      ...
      >
        <div className="flex flex-col items-center justify-center border-b border-[#ece2da] pb-7 lg:border-b-0 lg:border-r lg:pb-0 lg:pr-9">
          <strong className="font-serif text-[66px] font-normal leading-none text-[#C85956]">
            {summary.average.toFixed(1)}
          </strong>
          <div className="mt-3 text-[#C85956]">
              ...
              return (
                <div key={rating} className="grid grid-cols-[32px_1fr_42px] items-center gap-3 text-xs">
                  ...
                  <div className="h-[5px] overflow-hidden rounded-full bg-[#e8e2dc]">
                    <div className="h-full rounded-full bg-[#C85956]" style={{ width: `${percent}%` }} />
                  </div>
        ...
        <div className="flex flex-col items-center justify-center border-t border-[#ece2da] pt-7 text-center lg:border-l lg:border-t-0 lg:pl-9 lg:pt-0">
          <Heart className="h-11 w-11 text-[#C85956]" strokeWidth={1.7} />
          <strong className="mt-3 font-serif text-[38px] font-normal text-[#C85956]">{recommended}%</strong>
  ...
  return (
    <section aria-label="Rating summary" className="grid overflow-hidden rounded-[28px] border border-[#eaded1] bg-white shadow-[0_12px_40px_rgba(68,43,32,.06)] lg:grid-cols-[.7fr_1.3fr]">
      <div className="flex flex-col items-center justify-center bg-[#C85956] p-8 text-white">
      ...
      <div className="p-6 sm:p-8">
          ...
          {[5, 4, 3, 2, 1].map((rating) => {
            ...
            return (
              <div key={rating} className="grid grid-cols-[44px_1fr_66px] items-center gap-3 text-xs">
                ...
                <div className="h-2 overflow-hidden rounded-full bg-[#eee6dd]"><div className="h-full rounded-full bg-[#C85956]" style={{ width: `${percent}%` }} /></div>
        ...
        <div className="mt-6 flex flex-wrap gap-4 border-t border-[#eee5dc] pt-5 text-xs text-[#6d625b]">
          <span className="flex items-center gap-1.5"><CheckCircle2 className="h-4 w-4 text-[#C85956]" />{summary.verifiedPercent}% verified</span>
          <span className="flex items-center gap-1.5"><Camera className="h-4 w-4 text-[#C85956]" />{summary.withPhotos} with photos</span>
        </div>
      </div>
    </section>
  );
