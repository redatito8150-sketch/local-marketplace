    ...
    <form ref={formRef} action={basePath} className="flex flex-wrap items-center gap-2.5">
      ...
      <details className="relative">
        ...
        <div className="absolute left-0 top-[calc(100%+8px)] z-20 w-48 space-y-3 rounded-xl border border-[#e1d7ce] bg-white p-4 shadow-xl">
          ...
          <button className="min-h-9 w-full rounded-lg bg-[#C85956] px-3 text-xs font-bold text-white">Apply</button>
          <Link href={basePath} className="block text-center text-xs font-semibold text-[#C85956]">Reset filters</Link>
        </div>
      </details>
