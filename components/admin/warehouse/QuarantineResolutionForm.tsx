  ...
  return (
    <details className="group mt-3 rounded-xl bg-amber-50/70 p-3">
      ...
      <div className="mt-3 grid gap-2 lg:grid-cols-[220px_1fr_auto] lg:items-end">
        ...
        <button type="button" onClick={submit} disabled={!resolution || !note.trim() || busy} className="inline-flex h-11 items-center justify-center rounded-xl bg-[#C85956] px-4 text-[11px] font-bold text-white hover:bg-[#b84e4b] disabled:opacity-45">{busy ? <Loader2 className="mr-2 h-3.5 w-3.5 animate-spin" /> : null}Confirm resolution</button>
      </div>
