...
export default function CollectionsManager({ brandSlug }: { brandSlug: string }) {
  ...
  return (
    <div className="mb-10 rounded-[20px] border border-[#e5d8cd] bg-[#fffaf5] p-5 sm:p-7">
      ...
      {!collections ? (
        <div className="flex justify-center py-8"><Loader2 className="h-5 w-5 animate-spin text-[#8f2634]" /></div>
      ) : (
        <div className="mt-5 space-y-4">
                    ...
                    {isEditing ? (
                      <div className="space-y-2">
                        <input
                          ...
                          maxLength={80}
                          className="w-full rounded-md border border-[#ddd2c8] px-2 py-1.5 text-sm font-semibold outline-none focus:border-[#8f2634]"
                        />
                        <input
                          value={draft.tagline}
                          ...
                          maxLength={40}
                          className="w-full rounded-md border border-[#ddd2c8] px-2 py-1.5 text-xs outline-none focus:border-[#8f2634]"
                        />
                        <textarea
                        ...
                        <label className="block text-[11px] text-[#8b8078]">
                          ...
                          <input
                            ...
                            className="mt-1 w-full rounded-md border border-[#ddd2c8] px-2 py-1.5 text-xs outline-none focus:border-[#8f2634]"
                          />
                        </label>
                      ...
                      <>
                        <div className="flex items-start justify-between gap-2">
                          <div className="min-w-0">
                            ...
                            {collection.tagline && <p className="text-[11px] text-[#9b3440]">{collection.tagline}</p>}
                          </div>
                          <button
                            type="button"
                        ...
                        <div className="mt-2 flex flex-wrap items-center gap-1.5 text-[10px] font-semibold uppercase tracking-wide">
                          <span className={`rounded-full px-2 py-0.5 ${collection.isActive ? "bg-[#e6f4ea] text-[#2f7a4a]" : "bg-[#f4e6e6] text-[#8f2634]"}`}>
          ...
          {collections.length < MAX_COLLECTIONS &&
            (creating ? (
              <div className="flex items-center gap-2 rounded-2xl border-2 border-[#8f2634]/40 bg-white p-3">
                <input
                  value={newName}
                  ...
                  className="min-w-0 flex-1 rounded-md border border-[#ddd2c8] px-2 py-1.5 text-sm outline-none focus:border-[#8f2634]"
                />
                <button
                  type="button"
              ...
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-2xl border border-dashed border-[#c9b6a6] px-3 py-4 text-[12px] font-semibold text-[#8f2634]"
              >
