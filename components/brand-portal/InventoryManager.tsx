...
function buildVariantGroups(variants: BrandVariant[]): ProductVariantGroup[] {
  const products = new Map<string, { productName: string; variants: BrandVariant[]; colors: Map<string, ColorVariantGroup> }>();
