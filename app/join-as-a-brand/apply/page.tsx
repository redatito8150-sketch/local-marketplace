...
export const metadata: Metadata = {
  title: "Apply to Sell on Local | Join Local",
  description:
    "Submit your brand application to start selling on Local, Egypt's marketplace for independent local brands.",
};
