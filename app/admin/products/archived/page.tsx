...
export default async function AdminArchivedProductsPage(props: { searchParams: Promise<ArchivedParams> }) {
  ...
  return <div>
    ...
    <DashboardFilters action="/admin/products/archived" clearHref="/admin/products/archived" activeCount={params.q ? 1 : 0}><DashboardFilterField label="Search" className="lg:flex-1"><input name="q" defaultValue={params.q ?? ""} placeholder="Product, brand, SKU, or ID" className={`${dashboardFilterControl} w-full lg:min-w-[240px]`} /></DashboardFilterField></DashboardFilters>
