...
export default async function AdminApplicationsPage(props: { searchParams: Promise<ApplicationParams> }) {
  ...
  applications.sort((a, b) => params.sort === "oldest" ? submissionTime(a) - submissionTime(b) : params.sort === "brand" ? a.brandName.localeCompare(b.brandName) : submissionTime(b) - submissionTime(a));
