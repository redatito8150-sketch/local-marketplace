...
const ENTITY_LABELS: Record<string, string> = { product: "Product", brand: "Brand", order: "Order", application: "Application", profile: "User", coupon: "Coupon", site_content: "Site content", page: "Page", review: "Review", collection: "Collection", option_type: "Option type", option_value: "Option value" };
